...
<head>
    ...
    <link rel="stylesheet" href="<?php echo HESK_PATH; ?>css/bootstrap-iconpicker.min.css" type="text/css">
    ...
    <script language="JavaScript" type="text/javascript" src="<?php echo HESK_PATH; ?>js/iconset/iconset-fontawesome-4.2.0.min.js"></script>
    <script language="JavaScript" type="text/javascript" src="<?php echo HESK_PATH; ?>js/bootstrap-iconpicker.min.js"></script>
